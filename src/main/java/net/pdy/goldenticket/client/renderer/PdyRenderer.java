...
public class PdyRenderer extends HumanoidMobRenderer<PdyEntity, HumanoidModel<PdyEntity>> {
	public PdyRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<PdyEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
	}

	@Override
	public ResourceLocation getTextureLocation(PdyEntity entity) {
		return new ResourceLocation("golden_ticket:textures/entities/pdy.png");
	}
}
